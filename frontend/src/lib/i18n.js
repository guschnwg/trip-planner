...
const messages = {
  en: {
    ...
    comparisons: {
      title: 'Plans',
      empty: 'No comparisons yet. Create one to start comparing options side by side.',
      newComparison: 'New comparison',
      addPlan: 'Add plan',
      addItem: 'Add item',
      addPlanToTrip: 'Add all to trip',
      deleteComparison: 'Delete comparison',
      deletePlan: 'Delete plan',
      deleteItem: 'Delete item',
      comparisonNamePlaceholder: 'Comparison name',
      planNamePlaceholder: 'Plan name',
      prevComparison: 'Previous comparison',
      nextComparison: 'Next comparison',
      pick: 'Pick on map',
      pickHint: 'Click the map to choose a location.',
      paidToggle: 'Paid',
      summary: {
        items: '{count} items',
        free: '{count} free',
  ...
  pt: {
    ...
    comparisons: {
      title: 'Planos',
      empty: 'Nenhuma comparação ainda. Crie uma para começar a comparar opções lado a lado.',
      newComparison: 'Nova comparação',
      addPlan: 'Adicionar plano',
      addItem: 'Adicionar item',
      addPlanToTrip: 'Adicionar tudo à viagem',
      deleteComparison: 'Excluir comparação',
      deletePlan: 'Excluir plano',
      deleteItem: 'Excluir item',
      comparisonNamePlaceholder: 'Nome da comparação',
      planNamePlaceholder: 'Nome do plano',
      prevComparison: 'Comparação anterior',
      nextComparison: 'Próxima comparação',
      pick: 'Escolher no mapa',
      pickHint: 'Clique no mapa para escolher uma localização.',
      paidToggle: 'Pago',
      summary: {
        items: '{count} itens',
        free: '{count} grátis',
  ...
  es: {
    ...
    comparisons: {
      title: 'Planes',
      empty: 'Aún no hay comparaciones. Crea una para empezar a comparar opciones lado a lado.',
      newComparison: 'Nueva comparación',
      addPlan: 'Añadir plan',
      addItem: 'Añadir elemento',
      addPlanToTrip: 'Añadir todo al viaje',
      deleteComparison: 'Eliminar comparación',
      deletePlan: 'Eliminar plan',
      deleteItem: 'Eliminar elemento',
      comparisonNamePlaceholder: 'Nombre de la comparación',
      planNamePlaceholder: 'Nombre del plan',
      prevComparison: 'Comparación anterior',
      nextComparison: 'Siguiente comparación',
      pick: 'Elegir en el mapa',
      pickHint: 'Haz clic en el mapa para elegir una ubicación.',
      paidToggle: 'Pagado',
      summary: {
